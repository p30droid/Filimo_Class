...
class VideoCoverAdapter(mContext: Activity, data: MutableList<Video>) :
    RecyclerView.Adapter<VideoCoverAdapter.VideoVH>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): VideoVH {
        ...
        val view = inflater.inflate(R.layout.video_cover_row, null)
        return VideoVH(view)
    }
